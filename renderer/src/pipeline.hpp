...
struct PipelineConfigInfo {
  ...
  static PipelineConfigInfo defaultPipelineConfig(void);
};
...
private:
  // static size_t compileShader(glslang_stage_t stage,
  //                              const std::vector<char> &shaderSource,
  //                            ShaderModule &shaderModule);
  // static size_t compileShaderFile(const std::string &file,
  //                              ShaderModule &shaderModule);
